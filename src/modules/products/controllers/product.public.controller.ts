...
export class PublicProductController {
    ...
    public static async getProducts(req: Request, res: Response) {
        ...
        return new ApiResponse(res, HTTP_STATUS.OK, 'Catalog retrieved successfully', result).send();
    }
    ...
    public static async getProductById(req: Request, res: Response) {
        ...
        return new ApiResponse(res, HTTP_STATUS.OK, 'Product retrieved successfully', { product }).send();
    }
}