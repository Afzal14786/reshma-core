...
export class AdminProductController {
    ...
    public static async createProduct(req: Request, res: Response) {
        ...
        return new ApiResponse(res, HTTP_STATUS.CREATED, 'Product created successfully', { product }).send();
    }
    ...
    public static async updateProduct(req: Request, res: Response) {
        ...
        return new ApiResponse(res, HTTP_STATUS.OK, 'Product updated successfully', { product }).send();
    }
    ...
    public static async deleteProduct(req: Request, res: Response) {
        ...
        return new ApiResponse(res, HTTP_STATUS.OK, 'Product successfully removed from public catalog', null).send();
    }
}