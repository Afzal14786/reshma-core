...
export class CartController {
    ...
    public static async getCart(req: Request, res: Response) {
        ...
        return new ApiResponse(res, HTTP_STATUS.OK, 'Cart retrieved successfully', cartData).send();
    }
    ...
    public static async addItem(req: Request, res: Response) {
        ...
        return new ApiResponse(res, HTTP_STATUS.OK, 'Item added to cart successfully', updatedCart).send();
    }
    ...
    public static async updateItem(req: Request, res: Response) {
        ...
        return new ApiResponse(res, HTTP_STATUS.OK, 'Cart updated successfully', updatedCart).send();
    }
    ...
    public static async removeItem(req: Request, res: Response) {
        ...
        return new ApiResponse(res, HTTP_STATUS.OK, 'Item removed from cart', updatedCart).send();
    }
    ...
    public static async clearCart(req: Request, res: Response) {
        ...
        return new ApiResponse(res, HTTP_STATUS.OK, 'Cart cleared successfully', null).send();
    }
    ...
    public static async mergeCart(req: Request, res: Response) {
        ...
        return new ApiResponse(res, HTTP_STATUS.OK, 'Guest cart merged successfully', mergedCart).send();
    }
}