...
import { signAccessToken, signRefreshToken, setRefreshCookie, clearRefreshCookie } from './auth.utils';
...
export class AuthController {
    ...
    public static async register(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            ...
            new ApiResponse(res, HTTP_STATUS.CREATED, result.message, { user: result.user }).send();
        } catch (error: unknown) {
            next(error);
        }
    }
    ...
    public static async verifyOtp(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            ...
            new ApiResponse(res, HTTP_STATUS.OK, 'Email verified successfully. Welcome!', { user, accessToken }).send();
        } catch (error: unknown) {
            next(error);
        }
    }
    ...
    public static async login(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            ...
            new ApiResponse(res, HTTP_STATUS.OK, 'Login successful', { user, accessToken }).send();
        } catch (error: unknown) {
            next(error);
        }
    }
    ...
    public static async refresh(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            ...
            if (!refreshToken) {
                ...
                new ApiResponse(res, HTTP_STATUS.UNAUTHORIZED, 'Session expired. Please log in.', null).send();
                return;
            }
